...
A Debian menu for your website shows Debian networking icons in a un-obtrusive way.
...
1. Upload folder `debian-sidebar-lite` in Wordpress plugin directory `/wp-content/plugins/`.
